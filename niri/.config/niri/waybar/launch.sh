...
waybar -c ~/.config/niri/waybar/$config_file -s ~/.config/niri/waybar/$style_file &
# env GTK_DEBUG=interactive waybar -c ~/.config/niri/waybar/$config_file -s ~/.config/niri/waybar/$style_file &
