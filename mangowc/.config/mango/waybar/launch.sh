...
waybar -c ~/.config/mango/waybar/$config_file -s ~/.config/mango/waybar/$style_file &
# env GTK_DEBUG=interactive waybar -c ~/.config/mango/waybar/$config_file -s ~/.config/mango/waybar/$style_file &
